...
const loginUser = asyncHandler(async (req, res) => {
  ...
  //base on any one field for login
  if (!(username || email)) {
    throw new ApiError(400, "username or email is required");
  }
  //based on username and email login
  // if(!username && !email){
  //    throw new ApiError(400,"username or email is required")
  // }
...
const updateUserAvatar = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, user, "avatar is uploaded completed"));
});
...
const updateUserCoverImage = asyncHandler(async (req, res) => {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, user, "cover image is uploaded completed"));
});
export {
  registerUser,
  loginUser,
